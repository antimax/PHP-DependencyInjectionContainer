...
----------------------------
Insert following package definition into your composer.json
to install the piece of software with composer
```js
  "repositories": [
      {
        "type": "vcs",
        "url": "https://github.com/skvskv/PHP-DependencyInjectionContainer.git"
      }
  ],
```
...
```js
  "require": {
      "skvskv/PHP-DependencyInjectionContainer": "*"
  }
```
